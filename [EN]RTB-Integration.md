...
|country|string|Yes|Country code following ISO-3166-1-alpha-3|
...
|burl|string|Yes|Billing notice URL called by the exchange when a winning bid becomes billable based on exchange-specific business policy (e.g.,typically delivered, viewed, etc.).Substitution macros ${AUCTION_PRICE} may be included|
